"""
Analyze OPENAI GPT-4o results only (folders with suffix gpt4o).
Processes with-gloss and without-gloss; writes experiment_results_analysis_openai_gpt4o.xlsx.
Uses shared.analysis_utils. Columns: OPENAI_gpt4o_with_gloss, OPENAI_gpt4o_without_gloss.
"""
import os
import sys
import glob
...
def create_excel_tables(
    ...
    col_with = "OPENAI_gpt4o_with_gloss"
    col_without = "OPENAI_gpt4o_without_gloss"
    ...
    base_dir = os.path.dirname(os.path.abspath(__file__))
    output_file = os.path.join(base_dir, "experiment_results_analysis_openai_gpt4o.xlsx")
...
if __name__ == "__main__":
    print("=" * 80)
    print("OPENAI GPT-4o: Analysis (with gloss + without gloss)")
    print("=" * 80)
